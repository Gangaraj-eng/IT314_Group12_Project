...
public class RtcTokenBuilder {
   ...
   *     <ul>
   *       <li>The 26 lowercase English letters: a to z.
   *       <li>The 26 uppercase English letters: A to Z.
   *       <li>The 10 digits: 0 to 9.
   *       <li>The space.
   *       <li>"!", "#", "$", "%", "&", "(", ")", "+", "-", ":", ";", "<", "=", ".", ">", "?", "@",
   *           "[", "]", "^", "_", " {", "}", "|", "~", ",".
   *     </ul>
   ...
   *     <ul>
   *       <li>Role_Publisher = 1: RECOMMENDED. Use this role for a voice/video call or a live
   *           broadcast.
   *       <li>Role_Subscriber = 2: ONLY use this role if your live-broadcast scenario requires
   *           authentication for
   *           [Hosting-in](https://docs.agora.io/en/Agora%20Platform/terms?platform=All%20Platforms#hosting-in).
   *           In order for this role to take effect, please contact our support team to enable
   *           authentication for Hosting-in for you. Otherwise, Role_Subscriber still has the same
   *           privileges as Role_Publisher.
   *     </ul>
   *
   * @param privilegeTs Represented by the number of seconds elapsed since 1/1/1970. If, for
   *     example, you want to access the Agora Service within 10 minutes after the token is
   *     generated, set expireTimestamp as the current time stamp + 600 (seconds).
   */
  public String buildTokenWithUid(
    ...
    return buildTokenWithUserAccount(
        appId, appCertificate, channelName, account, role, privilegeTs);
  }
