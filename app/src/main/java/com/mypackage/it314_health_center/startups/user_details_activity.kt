...
class user_details_activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        next_btn.setOnClickListener {
            ...
            else if(age_view.text.toString().isEmpty() || age_view.text.toString().toInt()>=100 || age_view.text.toString().toInt()<=0)
            {
        ...
        confirm_btn.setOnClickListener {
            ...
            dialog.findViewById<TextView>(R.id.txt__verify).visibility=View.GONE
            dialog.show()
            val user_details=User_Details(name_view.text.toString(),"$day_text-$month_text-$year_text"
            ,age_view.text.toString().toInt(), gender_select.text.toString(),address_view_1.text.toString(),
            address_view_2.text.toString(),city_view.text.toString(),state_view.text.toString()
            ,country_view.text.toString(),pincode_view.text.toString().toInt())
